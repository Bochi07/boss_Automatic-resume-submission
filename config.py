...
def _load_raw_user_config():
    config_path = _PROJECT_DIR / 'user_config.json'
...
class Config:
    ...
    frontend = copy.deepcopy(USER_CONFIG['frontend'])
    backend = copy.deepcopy(USER_CONFIG['backend'])
    scoring = copy.deepcopy(USER_CONFIG['scoring'])
